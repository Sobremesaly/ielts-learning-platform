 ...
 * @author 小叶子
 */
public class DegreeOfSimilarity {
    ...
    private static String longestCommonSubstring(String strLong, String strShort) {
        char[] charsStrA = strLong.toCharArray();
        char[] charsStrB = strShort.toCharArray();
    ...
    public static double getDegree(String strA, String strB) {
        /*
        ...
        */
        return (similarDegree(strA, strB) + similarityRatio(strA, strB)) / 2;
    }
